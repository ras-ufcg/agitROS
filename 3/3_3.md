...
> :warning: Interestingly, `ros::init()` installs a handler for this signal, and uses it to initiate
...
The last new element of `pubvel` is its [use of a `ros::Rate`
object:]
...
You can confirm that this regulation is working correctly, using rostopic hz. For `pub
vel`, the results should look similar to this:
```
average rate: 2.000
...
> :warning: You might be thinking of an alternative to `ros::Rate` that uses a simple, fixed delay—
...
> :warning: If you skip (or forget) this step, then `catkin_make` may not be able to find the
...
![image](https://user-images.githubusercontent.com/48807586/124123404-aa558380-da4d-11eb-90c4-5f0652605170.png)
<p align="center">
  <img src="![image](https://user-images.githubusercontent.com/48807586/124123404-aa558380-da4d-11eb-90c4-5f0652605170.png)" width="400"/><br>
  <b><i><a name="2.2"> Figure 3.1:</a></b> A turtlesim turtle responding to random velocity commands from pubvel..</i>
</p>
