...
Quando todas as etapas de construção estão completas, o  seu novo programa ROS está pronto para execução usando `rosrun` (Section 2.6), assim como qualquer outro programa ROS. No nosso exemplo, o comando é: 
