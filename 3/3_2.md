...
- The `ros::NodeHandle` object is the main mechanism that your program will use to interact with the ROS system. [*](http://wiki.ros.org/roscpp/Overview/NodeHandles) Creating this object registers your program as a
