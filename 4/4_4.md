...
However, thesimplest way to see /rosout messages is to use [this command](http://wiki.ros.org/rqt_console):
```
rqt_console
```
...
<p align="center">
  ...
  <b><i><a name="2.2"> Figure 4.2:</a></b> The GUI for `rqt_console`.</i>
</p>
