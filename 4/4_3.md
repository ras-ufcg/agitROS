...
{: .no_toc }
Vamos dar uma olhada melhor em como gerar mensagens de log na linguagem C++.
{: .fs-6 .fw-300 }
...
> ```
> Também existem versões de estilo printf das famílias de macros de tempo único (..._ONCE) e conjugado (...
...
### Gerando mensagens de log conjugadas

De forma similar, existem macros para conjugar a taxa com 
...
#### **Lista 4.5**
{: .no_toc }
##### Um programa em C++ chamado `throttle.cpp` que mostra mensagens de log conjugadas.
{: .no_toc }
```
