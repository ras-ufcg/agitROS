...
#### **Lista 4.1**
{: .no_toc }
##### Um programa chamado `count.cpp` que gera mensagens de log em todos os cinco níveis de severidade.
{: .no_toc }

```
// Este programa periodicamente gera mensagens de logo a 
...
// Gera mensagens de log com severidade variando regularmente.
ros::Rate rate(10);
...
Existem 5 macros básicos de C++ para gerar mensagens de log, um para cada nível de severidade:
