...
#### **Lista 4.2**
{: .no_toc }
#### Sample output from running count for a few seconds. This output does not contain
...
#### **Lista 4.3**
{: .no_toc }
#### A fragment of C++ that disables a log message after its first execution. The
