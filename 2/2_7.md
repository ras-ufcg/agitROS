...
apropriado(s); um nó que deseja receber informações **se inscreve** no tópico ou tópicos de seu 
...
<p align="center">
  ...
  <i><b><a name="2.2"> Figura 2.2:</a></b> A interface <code>rqt_graph</code>, mostrando o gráfico para o exemplo <code>urtlesim</code>. Nós de depuração, incluindo 
...
opções para ajustar a forma como mostra o gráfico. A preferência pessoal do autor é alterar a lista suspensa de "Somente 
