...
Por exemplo, executar o arquivo de launch na Lista 6.1 envia a saída padrão de dois dos seus nós para um 
...
Nós iniciados com esse atributo exibirão a sua saída parão em tela ao invés de exibir nos arquivos 
...
>a saída que você espera, você deve verificar se aquele nó tem o atributo `output="screen"` habilitado. 
{: .fs-3 .code-example }
